...
public class FieldOfViewEditor : Editor
{
    private void OnSceneGUI()
    {
        ...
        Vector3 viewAngleA = DirectionFromAngle(transform.eulerAngles.y, -fov.ViewAngle / 2);
        Vector3 viewAngleB = DirectionFromAngle(transform.eulerAngles.y, fov.ViewAngle / 2);
